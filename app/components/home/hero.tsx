...
const Hero = () => {
  ...
  return (
    <div className='relative h-[550px] md:h-[620px] flex flex-col-reverse md:flex-row justify-end items-center px-10 pt-10 md:px-24 z-10 gap-3  bg-gradient-to-b from-white via-[#ffe7e7]  to-pink-200'>
